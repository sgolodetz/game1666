...
namespace game1666.Common.AStar
{
	...
	public static class AStarSearcher<NodeType> where NodeType : AStarNode<NodeType>
	{
		...
		public static LinkedList<NodeType> FindPath(NodeType source, ICollection<NodeType> destinations, IDictionary<string,dynamic> properties)
		{
			...
			while(openList.Count != 0)
			{
				...
				foreach(NodeType neighbour in cur.Neighbours(properties))
				{
