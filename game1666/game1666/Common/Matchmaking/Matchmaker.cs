...
{
	/// <summary>
	/// An instance of this class is used to match offers with requests.
	/// </summary>
	...
	class Matchmaker<OfferType, RequestType> where RequestType : IMatchmakingRequest<OfferType>
	{
		...
		private struct SourcedOffer
		{
			...
			/// </summary>
			private readonly IMatchmakingParticipant<OfferType, RequestType> m_source;
			...
			/// The source of the offer.
			/// </summary>
			public IMatchmakingParticipant<OfferType, RequestType> Source { get { return m_source; } }
			...
			public SourcedOffer(OfferType offer, IMatchmakingParticipant<OfferType, RequestType> source)
			{
				m_offer = offer;
				m_source = source;
			}
		...
		private struct SourcedRequest
		{
			...
			public SourcedRequest(RequestType request, IMatchmakingParticipant<OfferType, RequestType> source)
			{
				m_request = request;
				m_source = source;
			}
		...
		/// <summary>
		/// Adds an offer to the matchmaker.
		/// </summary>
		/// <param name="offer">The offer.</param>
		/// <param name="source">The source of the offer.</param>
		public void PostOffer(OfferType offer, IMatchmakingParticipant<OfferType, RequestType> source)
		{
			m_sourcedOffers.Add(new SourcedOffer(offer, source));
		}

		/// <summary>
		/// Adds a request to the matchmaker.
		/// </summary>
		/// <param name="request">The request.</param>
		/// <param name="source">The source of the request.</param>
		public void PostRequest(RequestType request, IMatchmakingParticipant<OfferType, RequestType> source)
		{
