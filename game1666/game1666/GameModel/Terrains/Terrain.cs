...
namespace game1666.Common.Terrains
{
	...
	/// </summary>
	sealed class Terrain : IPersistableObject
	{
		//#################### PRIVATE VARIABLES ####################
		#region
		...
		{
			XElement terrainElt = ObjectPersister.ConstructObjectElement(GetType());
			PropertyPersister.SaveProperties(terrainElt, m_properties);
			return terrainElt;
		}
