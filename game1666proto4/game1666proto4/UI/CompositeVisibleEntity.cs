...
namespace game1666proto4.UI
{
	...
	abstract class CompositeVisibleEntity : VisibleEntity, ICompositeEntity
	{
		...
		protected CompositeVisibleEntity(INamedEntity world)
		:	base(world)
		{}
		...
		/// <param name="world">The world that is being viewed.</param>
		protected CompositeVisibleEntity(IDictionary<string,dynamic> properties, INamedEntity world)
		...
		/// <param name="world">The world that is being viewed.</param>
		protected CompositeVisibleEntity(XElement entityElt, INamedEntity world)
