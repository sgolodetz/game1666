...
namespace game1666proto4.Common.Entities2
{
	...
	static class EntityLoader
	{
		...
		public static void LoadChildEntities(ICompositeEntity composite, XElement entityElt)
		{
			foreach(XElement childElt in entityElt.Elements("entity"))
			{
				...
				if(childType != null)
				{
					// Construct the child entity and add it to the composite.
					composite.AddDynamicEntity(Activator.CreateInstance(childType, childElt));
				}
				else
				{
